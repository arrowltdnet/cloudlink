...
* Add system info (Client + Server metrics) ([167235f](https://github.com/arrowltdnet/cloudlink/commit/167235f7bab6bf0812e3ecd49cf695c4022d76ce))
* Add system info (Client + Server metrics) ([#2311](https://github.com/arrowltdnet/cloudlink/issues/2311)) ([adaa1af](https://github.com/arrowltdnet/cloudlink/commit/adaa1af167a03ab033f4ecb121e9fc41c1d0640e))
* **data-access:** move puter.js read to app driver ([5021c44](https://github.com/arrowltdnet/cloudlink/commit/5021c44c6af0834781416f94f0c711011d56e7a1))
* **data-access:** move puter.js read to app driver ([2fa42f6](https://github.com/arrowltdnet/cloudlink/commit/2fa42f6669cfd3543d3280841de7f6efee0a24a5))
* dynamo in oss ([#2195](https://github.com/arrowltdnet/cloudlink/issues/2195)) ([c2e21ee](https://github.com/arrowltdnet/cloudlink/commit/c2e21ee2caf1ffb619dc8a385803495de038f6e8))
* give referrals ([#2262](https://github.com/arrowltdnet/cloudlink/issues/2262)) ([f8672bc](https://github.com/arrowltdnet/cloudlink/commit/f8672bc86daeaf4b217c518b2911d24f7f887918))
* **gui:** add keyboard shortcuts guide dialog ([#2278](https://github.com/arrowltdnet/cloudlink/issues/2278)) ([5bb6bde](https://github.com/arrowltdnet/cloudlink/commit/5bb6bde7cfcfabe51a290c9d01734743e26aa1fc))
* implement redirect for hosting base domain ([0b531ed](https://github.com/arrowltdnet/cloudlink/commit/0b531ed6a1c2f053992bdc09099006bdf3c7376d)), closes [#2214](https://github.com/arrowltdnet/cloudlink/issues/2214)
* KV testing ([#2061](https://github.com/arrowltdnet/cloudlink/issues/2061)) ([50d62d8](https://github.com/arrowltdnet/cloudlink/commit/50d62d89e813f564117bc5ad92452129e4153b8e))
* kv.remove feature to remove nested elements or list indices ([#2258](https://github.com/arrowltdnet/cloudlink/issues/2258)) ([40b24d5](https://github.com/arrowltdnet/cloudlink/commit/40b24d5979ebff0491302513dbb7d8a855041ae4))
* MeteringService test fixes for now ([#2050](https://github.com/arrowltdnet/cloudlink/issues/2050)) ([c427989](https://github.com/arrowltdnet/cloudlink/commit/c4279894dd7961b83984b4d990cabe6ebb9ae545))
* meteringService test suite ([#2052](https://github.com/arrowltdnet/cloudlink/issues/2052)) ([cd64fce](https://github.com/arrowltdnet/cloudlink/commit/cd64fcee1840bb99ce978173c20f1d79a334e5e6))
* method for updating users metering directly ([#2252](https://github.com/arrowltdnet/cloudlink/issues/2252)) ([e30a5ae](https://github.com/arrowltdnet/cloudlink/commit/e30a5aec5862ce74b2cc43d92342300a51ac8b60))
* more extension controller decorators ([#2272](https://github.com/arrowltdnet/cloudlink/issues/2272)) ([86549ac](https://github.com/arrowltdnet/cloudlink/commit/86549accc6f85baa10fc5ae3ad6f40d17242ef37))
* new kvstore operatios for more granular updates :rocket: ([#2254](https://github.com/arrowltdnet/cloudlink/issues/2254)) ([a39e188](https://github.com/arrowltdnet/cloudlink/commit/a39e1885ddaf97b20ec414e6b045acf420461b5e))
* paginated list ([#2296](https://github.com/arrowltdnet/cloudlink/issues/2296)) ([a3dc4d6](https://github.com/arrowltdnet/cloudlink/commit/a3dc4d60acc3074eaa51a1843df93b49bccfebba))
* **puter.js:** make home directory default cwd ([b4c5f9f](https://github.com/arrowltdnet/cloudlink/commit/b4c5f9fc72b3506eb5eed13f6b47c2ef468c0d71))
* refactor ai to have single entry point and follow defined model structure ([#2114](https://github.com/arrowltdnet/cloudlink/issues/2114)) ([413ed19](https://github.com/arrowltdnet/cloudlink/commit/413ed19a8011e87c8e41155b65c03b6445886135))
* rename ai models to match norm ([#2121](https://github.com/arrowltdnet/cloudlink/issues/2121)) ([4548b51](https://github.com/arrowltdnet/cloudlink/commit/4548b51f3d655f1dae26739edd0a6804b706b875))
* replace serializible caches with redis instead of kvjs :rocket: ([#2381](https://github.com/arrowltdnet/cloudlink/issues/2381)) ([a16fad0](https://github.com/arrowltdnet/cloudlink/commit/a16fad04d398331ac192d895e095fec3fff24d73))
* Settings and modal UI/UX improvements ([#1828](https://github.com/arrowltdnet/cloudlink/issues/1828)) ([ce29595](https://github.com/arrowltdnet/cloudlink/commit/ce29595dd6db82322e6a70206feeda3f97116117))
* single image ai endpoint ([#2129](https://github.com/arrowltdnet/cloudlink/issues/2129)) ([20f0242](https://github.com/arrowltdnet/cloudlink/commit/20f0242468f9d60d17f72e5181e05074e6d45b8f))
* support extension divs headers and tags being inserted to puter homepage load ([#2221](https://github.com/arrowltdnet/cloudlink/issues/2221)) ([68db7cf](https://github.com/arrowltdnet/cloudlink/commit/68db7cfda3d94d7fd7b3857cd21ce823b4325f00))
* usage endpoints, allow appName ([#2303](https://github.com/arrowltdnet/cloudlink/issues/2303)) ([a4ada85](https://github.com/arrowltdnet/cloudlink/commit/a4ada85ca091e7e7eb6efd569ab2c287161597a4))


### Bug Fixes

* add back test ([#2317](https://github.com/arrowltdnet/cloudlink/issues/2317)) ([df422df](https://github.com/arrowltdnet/cloudlink/commit/df422dfd18d9254269a35877345c533dc3683806))
* add catch all for minimum usage amounts ([#2248](https://github.com/arrowltdnet/cloudlink/issues/2248)) ([9d46618](https://github.com/arrowltdnet/cloudlink/commit/9d46618f0d2223ae94d8101db8e331ac305ee4b3))
* Add debounce to toolbar reveal when dragging windows to prevent accidental activation ([#1989](https://github.com/arrowltdnet/cloudlink/issues/1989)) ([d91d6be](https://github.com/arrowltdnet/cloudlink/commit/d91d6be636b58c07989c4f60dfbeb002357605eb))
* add missing 'tel' runtime module ([d33128d](https://github.com/arrowltdnet/cloudlink/commit/d33128d864bd2cb62fc3e97fc6be9f1b8c4a73b5))
* add missing Context import to IconResult ([e16850a](https://github.com/arrowltdnet/cloudlink/commit/e16850aa081b242d431dc98f8c352d6d0933de7f))
* add missing ref to `next()` ([ee522ec](https://github.com/arrowltdnet/cloudlink/commit/ee522ec7e31ce91dbfcf6d2a33d4ffb3ac9f18a1))
* add simple 30s cache to /healthcheck ([8cfa0cd](https://github.com/arrowltdnet/cloudlink/commit/8cfa0cd4b64207a8fa479fb78b4ebd138364d4a3))
* ai metering ([#2393](https://github.com/arrowltdnet/cloudlink/issues/2393)) ([4767b99](https://github.com/arrowltdnet/cloudlink/commit/4767b99b1ec672355f95dadc4d7f44e96e5d9600))
* alerting for metering ([#2399](https://github.com/arrowltdnet/cloudlink/issues/2399)) ([df47910](https://github.com/arrowltdnet/cloudlink/commit/df47910ca88ea7b8ba42704ef696debfffda92c6))
* app-under-user access token ACL ([036bdf1](https://github.com/arrowltdnet/cloudlink/commit/036bdf129f50502289d61ed73dd5456d70750b43))
* attempt coercion to fix vscode corruption ([11feb10](https://github.com/arrowltdnet/cloudlink/commit/11feb10d26e053f0230f19dcb1898f8194c2d2af))
* backend tests breaking with permision ([#2067](https://github.com/arrowltdnet/cloudlink/issues/2067)) ([59c05d7](https://github.com/arrowltdnet/cloudlink/commit/59c05d7238b0a005aff9ca3e9990dc1388b8a67b))
* **backend:** fix context dual-instance problem ([793d99a](https://github.com/arrowltdnet/cloudlink/commit/793d99abafccc1fc0d731cf161f17640acc717ee))
* **backend:** handle ll_mkdir exists race condition ([d392081](https://github.com/arrowltdnet/cloudlink/commit/d392081270f3321faf006d870ccd36fec5a16d97))
* **backend:** race condition in hashing_stream ([7a7f3e8](https://github.com/arrowltdnet/cloudlink/commit/7a7f3e8f319917ad88a3b7aecdd7faa1c7122a23))
* **backend:** singleton in helpers for testability ([46b1ec4](https://github.com/arrowltdnet/cloudlink/commit/46b1ec43a8b887f3809d428097eb124204f3621f))
* **backend:** status code check and handle HLMkdir ([1e1fc5f](https://github.com/arrowltdnet/cloudlink/commit/1e1fc5f53d925ef53d2273ff1bc207ba96dcac05)), closes [#1603](https://github.com/arrowltdnet/cloudlink/issues/1603)
* **backend:** update protected app perm implicator ([b87f3b8](https://github.com/arrowltdnet/cloudlink/commit/b87f3b897844ce0a88082ebe32175eb981536375))
* bad ai calls ([#2144](https://github.com/arrowltdnet/cloudlink/issues/2144)) ([09ea638](https://github.com/arrowltdnet/cloudlink/commit/09ea63806e975258963fc79f15e95929ded0f213))
* bad caching query crashing our db ([#2172](https://github.com/arrowltdnet/cloudlink/issues/2172)) ([6e7f229](https://github.com/arrowltdnet/cloudlink/commit/6e7f2297386e37a32cfd675c5c4ae928ab2f5a58))
* bad export ([6f6e58e](https://github.com/arrowltdnet/cloudlink/commit/6f6e58e18ff9449c0694becb2aa649d851876f56))
* bad method name for together ai ([#2128](https://github.com/arrowltdnet/cloudlink/issues/2128)) ([ef2e826](https://github.com/arrowltdnet/cloudlink/commit/ef2e8266ff722f6f1b0d5523eb89bd7b533f859a))
* bad usageType ([#2157](https://github.com/arrowltdnet/cloudlink/issues/2157)) ([1d63bd4](https://github.com/arrowltdnet/cloudlink/commit/1d63bd458b854c12e58dfa5104faefb5f947e3d7))
* batch app info referral ([#2146](https://github.com/arrowltdnet/cloudlink/issues/2146)) ([f8c9f5f](https://github.com/arrowltdnet/cloudlink/commit/f8c9f5f3de56342d9fcc50aee7ddf10ed65da8b0))
* batch fetch get apps for launch apps and recommended apps ([#2315](https://github.com/arrowltdnet/cloudlink/issues/2315)) ([3d049fa](https://github.com/arrowltdnet/cloudlink/commit/3d049fac0ef581cfc7eb65c936d202a128d733b6))
* cache get_app result with expiry to lessen load on db ([#2229](https://github.com/arrowltdnet/cloudlink/issues/2229)) ([b3f5d1b](https://github.com/arrowltdnet/cloudlink/commit/b3f5d1bfa415e76d92edd0847d6233550c9410dd))
* cost mapping for together ai from openai sdk ([#2371](https://github.com/arrowltdnet/cloudlink/issues/2371)) ([eea3a61](https://github.com/arrowltdnet/cloudlink/commit/eea3a61d9b7164614b0fe7f096659ddb366466ed))
* **data-access:** add guard for app actors ([7b2f855](https://github.com/arrowltdnet/cloudlink/commit/7b2f8552d10b971fa9a8dc34a9daeb716599e909))
* **data-access:** read response regression ([5490571](https://github.com/arrowltdnet/cloudlink/commit/54905714a52df5567fb4eb5dc32c7641bb73db71))
* dedup get_apps app requests ([#2325](https://github.com/arrowltdnet/cloudlink/issues/2325)) ([f1a1727](https://github.com/arrowltdnet/cloudlink/commit/f1a17274907ba4f61371511f6bd97de319fb03c6))
* desktop_items in whoami ([8581550](https://github.com/arrowltdnet/cloudlink/commit/8581550792eba846f8b81ed4ad324b94db6987f9))
* disable bad token checks? ([#2326](https://github.com/arrowltdnet/cloudlink/issues/2326)) ([d02820f](https://github.com/arrowltdnet/cloudlink/commit/d02820fec508e40f2fa2d9314be4fdcbbcf327a9))
* disable requests from server in two services ([efae7f8](https://github.com/arrowltdnet/cloudlink/commit/efae7f81e20b0b0b9700f59076e6e3f8b44a77d0))
* don't cache nor fetch raw b64 url for app icons ([#2230](https://github.com/arrowltdnet/cloudlink/issues/2230)) ([3d837a8](https://github.com/arrowltdnet/cloudlink/commit/3d837a8be9695f5b211e4376d38905eb3d830b99))
* don't load bench.js files ([#2207](https://github.com/arrowltdnet/cloudlink/issues/2207)) ([e94b2e0](https://github.com/arrowltdnet/cloudlink/commit/e94b2e0234cef3c276457b0d94e56b1f3f6da6ae))
* downgrade opentelemetry so it works again ([d261398](https://github.com/arrowltdnet/cloudlink/commit/d261398d14992078266837e9efc2d2c89eb21d58))
* eleven labs metering costs ([#2112](https://github.com/arrowltdnet/cloudlink/issues/2112)) ([c31a4c6](https://github.com/arrowltdnet/cloudlink/commit/c31a4c6f940cdb6b78d924e8bc18746ddb885a63))
* Enable godmode for dev-center to open worker files in editor ([#2224](https://github.com/arrowltdnet/cloudlink/issues/2224)) ([d71fea1](https://github.com/arrowltdnet/cloudlink/commit/d71fea1e37404d363c0fed00c698590119cd4dab))
* eslint autofixable errors ([#2002](https://github.com/arrowltdnet/cloudlink/issues/2002)) ([fecd15e](https://github.com/arrowltdnet/cloudlink/commit/fecd15e29ba8431ec1a62da5cfd5646eea520f5a))
* explicit actor not passed to fs provider ([11c3c43](https://github.com/arrowltdnet/cloudlink/commit/11c3c43afba7a990d2ba3e872b0cc7312c0bd4d7))
* expose getUserService in extension typings ([#2385](https://github.com/arrowltdnet/cloudlink/issues/2385)) ([08b68a3](https://github.com/arrowltdnet/cloudlink/commit/08b68a3657603f3d61f35dc93df5c9ac941ecd1f))
* fallback models ([#2005](https://github.com/arrowltdnet/cloudlink/issues/2005)) ([cc333a3](https://github.com/arrowltdnet/cloudlink/commit/cc333a337b692d90b406922cb852667337eedcef))
* fsNode.is() requiring unnecessary fetch ([fd4f3bc](https://github.com/arrowltdnet/cloudlink/commit/fd4f3bc979a7cbaaad75db4593daa6e46a9fce1b))
* get subdomains permission working ([cd09e0d](https://github.com/arrowltdnet/cloudlink/commit/cd09e0d1c855b2c756aca166f79b28d543f2c410))
* header resend issue with catch-all handler ([e465cef](https://github.com/arrowltdnet/cloudlink/commit/e465cefd95340be12a287fa2bba8136a8849de1e))
* husky ([#2260](https://github.com/arrowltdnet/cloudlink/issues/2260)) ([4636d93](https://github.com/arrowltdnet/cloudlink/commit/4636d9332e5e542e03d03771b942149141ef59b9))
* id2path import ([152bc55](https://github.com/arrowltdnet/cloudlink/commit/152bc5553c4c7cf4ec7f2aaa615a7d6be75a3951))
* import issues on run form benchmarks (somehow) ([2ff77b4](https://github.com/arrowltdnet/cloudlink/commit/2ff77b439709b48efabcc69158f4dcb5b147ada2))
* improve response error handling in Perms module ([ed5e6db](https://github.com/arrowltdnet/cloudlink/commit/ed5e6db992b044df170110ac967aeba584c35b4a))
* inaccurate error on update of non-existing ([91856cb](https://github.com/arrowltdnet/cloudlink/commit/91856cbdd4aefbc7d0b984d8762d0eeaade488cc))
* incorrect variable ref in hl_move for shared ([db63a08](https://github.com/arrowltdnet/cloudlink/commit/db63a088a44efb204a687380b651dbb432170422))
* issues creating shortcuts ([1e510c4](https://github.com/arrowltdnet/cloudlink/commit/1e510c44e41464f77e9b0c0375e992fddf6ddce6)), closes [#2200](https://github.com/arrowltdnet/cloudlink/issues/2200)
* log format ([#2333](https://github.com/arrowltdnet/cloudlink/issues/2333)) ([c11300b](https://github.com/arrowltdnet/cloudlink/commit/c11300bcb4b5f0dd4ae2aa8e23d03a6e5dc37d90))
* make cache calls async on boot ([#2173](https://github.com/arrowltdnet/cloudlink/issues/2173)) ([5b9f82b](https://github.com/arrowltdnet/cloudlink/commit/5b9f82b6e576984df1737732d0a587d7f7ab0efe))
* map again ([#2372](https://github.com/arrowltdnet/cloudlink/issues/2372)) ([3e2b528](https://github.com/arrowltdnet/cloudlink/commit/3e2b528f908b760b0b64972666e75dc664684cd4))
* match override properly ([#2373](https://github.com/arrowltdnet/cloudlink/issues/2373)) ([561037f](https://github.com/arrowltdnet/cloudlink/commit/561037f5d40514b1a9355f2488b28c6e6a00e71c))
* metering service alerts + missing claude costs ([#2058](https://github.com/arrowltdnet/cloudlink/issues/2058)) ([b8b94f1](https://github.com/arrowltdnet/cloudlink/commit/b8b94f17693f828923f4c98386c7412091d85425))
* minor issue in root package.json ([4c42727](https://github.com/arrowltdnet/cloudlink/commit/4c427274d5c4c6a67882fe747114889d546004c4))
* missing published/attached website icon for folder on different views ([#1764](https://github.com/arrowltdnet/cloudlink/issues/1764)) ([#1945](https://github.com/arrowltdnet/cloudlink/issues/1945)) ([824706d](https://github.com/arrowltdnet/cloudlink/commit/824706dd13079486336d26f006a6bf75cbf711ae))
* missing redis changes ([#2401](https://github.com/arrowltdnet/cloudlink/issues/2401)) ([27c6bf3](https://github.com/arrowltdnet/cloudlink/commit/27c6bf346b31a1f7239194691967c4c842e48860))
* missing video gen ai services in ai module ([#2180](https://github.com/arrowltdnet/cloudlink/issues/2180)) ([75952eb](https://github.com/arrowltdnet/cloudlink/commit/75952ebad72b7ee44691d4ea0d3727b9713ab5fe))
* more reliable 404 responses for `.api` endpoint ([a020b53](https://github.com/arrowltdnet/cloudlink/commit/a020b5358f6d02ccf8259c01e2a7943ba2aa9871))
* more strict metering limits, disable ambigious openrouter one ([#2249](https://github.com/arrowltdnet/cloudlink/issues/2249)) ([06a2a4d](https://github.com/arrowltdnet/cloudlink/commit/06a2a4d04a123458ad600d6be0d0737f1879d6c7))
* move dependency in LocalDiskStorageController ([e8b3be7](https://github.com/arrowltdnet/cloudlink/commit/e8b3be7b5906248129f0c1b48f036ac5abdac2d7))
* normalize file object in `/writeFile` ([af0b809](https://github.com/arrowltdnet/cloudlink/commit/af0b80956361f502b25baed7775163b155e81305))
* only fallback to models that are immediately the same ([#2001](https://github.com/arrowltdnet/cloudlink/issues/2001)) ([3139569](https://github.com/arrowltdnet/cloudlink/commit/3139569dfbb356c581ebb194a7f001aadac1b984))
* only rate limit login when failed ([#2355](https://github.com/arrowltdnet/cloudlink/issues/2355)) ([3dac8c9](https://github.com/arrowltdnet/cloudlink/commit/3dac8c9db0c5ccc1bd35a925102b03718fbf6d10))
* open router cache token metering ([#1988](https://github.com/arrowltdnet/cloudlink/issues/1988)) ([e060c27](https://github.com/arrowltdnet/cloudlink/commit/e060c273f7b8e9371ee26bcb335c2798a754d234))
* openrouter costs always being 0 ([#2250](https://github.com/arrowltdnet/cloudlink/issues/2250)) ([a033b76](https://github.com/arrowltdnet/cloudlink/commit/a033b76c65df8b0c3f1f9eb6b6dedb79dc2be82e))
* openrouter missing usage ([#2008](https://github.com/arrowltdnet/cloudlink/issues/2008)) ([a893963](https://github.com/arrowltdnet/cloudlink/commit/a8939637dac2d11018b76df6fc47ab38ea28efa7))
* oss boot error fixes ([#2039](https://github.com/arrowltdnet/cloudlink/issues/2039)) ([73b69df](https://github.com/arrowltdnet/cloudlink/commit/73b69dffa362faabcc6e7c6e4c463dc944db00c8))
* pass exporter to NodeSDK constructor ([77cf2e5](https://github.com/arrowltdnet/cloudlink/commit/77cf2e51691dc36c0a03c9571db2c19bfb36cc73))
* **perms:** fix revokePermission for "flat" impl ([a114afe](https://github.com/arrowltdnet/cloudlink/commit/a114afe310cbf71f837795e9e1b90c2372a0aac9))
* possible undefined when handling stuck stream ([6f14dcb](https://github.com/arrowltdnet/cloudlink/commit/6f14dcb0adca236e804573a3fc083282c47729b0))
* prevent loop if failing ai models? ([#2122](https://github.com/arrowltdnet/cloudlink/issues/2122)) ([f5884c3](https://github.com/arrowltdnet/cloudlink/commit/f5884c392e79e4aa9ceb3d0017b3ec840f3c3339))
* **puter.js:** check for uuid before relative path ([815d0da](https://github.com/arrowltdnet/cloudlink/commit/815d0da92469b1cca060b5c4ff6160311885dbf7))
* **puterfs:** use node `crypto` instead of Web API ([6ed9fb7](https://github.com/arrowltdnet/cloudlink/commit/6ed9fb7d86e7e4ac77a8474feb6bc678a8f6e561))
* range headers in file.js ([132eac9](https://github.com/arrowltdnet/cloudlink/commit/132eac9011db2045f05d834beb4ec3d69afd0120))
* references to `global_config` in puterfs ([8b3ee86](https://github.com/arrowltdnet/cloudlink/commit/8b3ee864efca9f7a2a2b74b24db20fa5dff7e21b))
* remove rate limit await on writes ([#2368](https://github.com/arrowltdnet/cloudlink/issues/2368)) ([8b4a713](https://github.com/arrowltdnet/cloudlink/commit/8b4a7134417ee86b713c96359cfcdf052c9fa6b9))
* requestPermission Promise never settled ([b585d7d](https://github.com/arrowltdnet/cloudlink/commit/b585d7dbd449fab0b1f17557fcae59e351264dbd))
* **resume-analyzer:** add preprocessing for DOCX and TXT files ([#2359](https://github.com/arrowltdnet/cloudlink/issues/2359)) ([6053055](https://github.com/arrowltdnet/cloudlink/commit/605305566402af40f71c7528533e90ae9083b162))
* shard app usages properly by user ([#2279](https://github.com/arrowltdnet/cloudlink/issues/2279)) ([48fbd97](https://github.com/arrowltdnet/cloudlink/commit/48fbd97d2efeac171a6505ff47c9d947ddb92541))
* size_measure_stream in streamutils ([d8d7948](https://github.com/arrowltdnet/cloudlink/commit/d8d7948a8ebdebbe07132f8616e674b169685795))
* skip cache when checking user:&lt;&gt;:email:read ([5484050](https://github.com/arrowltdnet/cloudlink/commit/5484050f7b0d6c4f453bc60d08ca1867dabc37bd))
* skip CI tests when only docs are changed ([#2335](https://github.com/arrowltdnet/cloudlink/issues/2335)) ([#2338](https://github.com/arrowltdnet/cloudlink/issues/2338)) ([7bd2fc1](https://github.com/arrowltdnet/cloudlink/commit/7bd2fc17d83c6ae30972e3137598beb2af481f66))
* stricten undef checks ([#2082](https://github.com/arrowltdnet/cloudlink/issues/2082)) ([d62d1fa](https://github.com/arrowltdnet/cloudlink/commit/d62d1fa3b91d23ad827789d994a6e5e6577f43ec))
* suggested apps breaking ([#2343](https://github.com/arrowltdnet/cloudlink/issues/2343)) ([39a46a2](https://github.com/arrowltdnet/cloudlink/commit/39a46a249dae15ad5a7b85839d02190eebbe1825))
* TelemetryService ([#2077](https://github.com/arrowltdnet/cloudlink/issues/2077)) ([5a9b829](https://github.com/arrowltdnet/cloudlink/commit/5a9b829a6a6dd85c1bce01ca5bcb76bd63ffeee0))
* together ai image prices ([#2130](https://github.com/arrowltdnet/cloudlink/issues/2130)) ([ecc7bb4](https://github.com/arrowltdnet/cloudlink/commit/ecc7bb48f778dbeb7f46b67545346a98d25ec11f))
* ts extensions ([#2247](https://github.com/arrowltdnet/cloudlink/issues/2247)) ([80af047](https://github.com/arrowltdnet/cloudlink/commit/80af0471bd47a30b66ab0ed88feecb92f84dd650))
* tsconfig to ignore vite config files ([#2048](https://github.com/arrowltdnet/cloudlink/issues/2048)) ([a0a9f16](https://github.com/arrowltdnet/cloudlink/commit/a0a9f161a121dbb3e5b70feb9e93f08dd2f070ff))
* types and tests? ([#2193](https://github.com/arrowltdnet/cloudlink/issues/2193)) ([b1c86a0](https://github.com/arrowltdnet/cloudlink/commit/b1c86a02701df28faa9b22c8755b8a2ce26c3cd8))
* typo in dbkvStore ([#2066](https://github.com/arrowltdnet/cloudlink/issues/2066)) ([fb2923d](https://github.com/arrowltdnet/cloudlink/commit/fb2923d52ef2ec367ce2f9767927800387d285e7))
* update import in TestService ([7f97c8e](https://github.com/arrowltdnet/cloudlink/commit/7f97c8e9d4f4b2706e89dc654d56df62dac70460))
* update MeteringService and add utility for TestKernel ([5fc26f4](https://github.com/arrowltdnet/cloudlink/commit/5fc26f419d5a9b652bb8e98d4020578cf745e876))
* update validation for permission endpoints ([161d87e](https://github.com/arrowltdnet/cloudlink/commit/161d87ec58d44dd101ffe39e94fb9fe274903f51))
* wrong order for telemetery init ([#2078](https://github.com/arrowltdnet/cloudlink/issues/2078)) ([55d9058](https://github.com/arrowltdnet/cloudlink/commit/55d90589cb2b60ba1fa8212313cbd90b0b334139))
* x86 not booting locally ([#1959](https://github.com/arrowltdnet/cloudlink/issues/1959)) ([81f407b](https://github.com/arrowltdnet/cloudlink/commit/81f407bca1c18668a9556c471ac9a34dd81422a7))


### Performance Improvements

* [+] readdirstat_uuid optimized implementation ([682613c](https://github.com/arrowltdnet/cloudlink/commit/682613cb9829108cf27bde5a0c333438a9b90281))
* batch readdir suggested apps into single big query ([#2332](https://github.com/arrowltdnet/cloudlink/issues/2332)) ([4934131](https://github.com/arrowltdnet/cloudlink/commit/49341310e68ecf755d3c51ac09f06c960136c417))
* condition for re-fetch in fsNode.exists() ([16a5026](https://github.com/arrowltdnet/cloudlink/commit/16a502696b0ac7808e525da0531a7089adf457a7))
* dedup and cache get_apps in puter gui, also add more app batching in backend ([#2319](https://github.com/arrowltdnet/cloudlink/issues/2319)) ([69529ae](https://github.com/arrowltdnet/cloudlink/commit/69529aeb12fe88ac5618a781d531dacc3898c805))
* don't await on modifying 'accessed' ([996f9a6](https://github.com/arrowltdnet/cloudlink/commit/996f9a62ddd4946532a2e854bc48feb39f28089c))
* don't fetch b64 icon for apps always, and lru suggestedApps ([#2336](https://github.com/arrowltdnet/cloudlink/issues/2336)) ([d0e526e](https://github.com/arrowltdnet/cloudlink/commit/d0e526ea89d440da65dfb354b85b0064016ad32e))
* **es:** generate client-safe objects in parallel ([ae73362](https://github.com/arrowltdnet/cloudlink/commit/ae73362bc32c9c779abab8f9ff059e19519a9311))
* improve parallelization in SQLES ([50c1608](https://github.com/arrowltdnet/cloudlink/commit/50c1608eb08af5540690448443a699d049731254))
* improve tel + decrease logs ([#2309](https://github.com/arrowltdnet/cloudlink/issues/2309)) ([f44e506](https://github.com/arrowltdnet/cloudlink/commit/f44e50674b57584505aee5a07532a6200608f087))
* is()/is_above() determine when to fetch ([543eff1](https://github.com/arrowltdnet/cloudlink/commit/543eff18e951ce024023e699f9adca496b852429))
* make app entries more scalable, avoid writing global entries since its just puter itself and isn't relevant ([#2233](https://github.com/arrowltdnet/cloudlink/issues/2233)) ([102fd5e](https://github.com/arrowltdnet/cloudlink/commit/102fd5ea8b4b8746ab5d4f86a902605523fcf67a))
* more benchmarks ([0dbd9e4](https://github.com/arrowltdnet/cloudlink/commit/0dbd9e40fd40146e0c19df8767070249747594fd))
* more benchmarks (2) ([bec820b](https://github.com/arrowltdnet/cloudlink/commit/bec820bbacf690e82357ea7f51df8b5354e85acc))
* split implied user-app permissions ([a92f857](https://github.com/arrowltdnet/cloudlink/commit/a92f857aba41fb913d5863d370cc16d49c5702c2))


### Reverts

* change to ai model names ([#2123](https://github.com/arrowltdnet/cloudlink/issues/2123)) ([74d7404](https://github.com/arrowltdnet/cloudlink/commit/74d7404a5a44ff3b4831d60219a038fa273ab81f))
* single ai image entry point ([#2131](https://github.com/arrowltdnet/cloudlink/issues/2131)) ([7bb749a](https://github.com/arrowltdnet/cloudlink/commit/7bb749a8a56fcce316bccb7d7bc319cfbfcf4f3d))
